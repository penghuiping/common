...
public class RBloomFilter {
     ...
     * @param fpp                可接受的错误率
     */
    public RBloomFilter(StringRedisTemplate redisTemplate, String name, long expectedInsertions, double fpp) {
    ...
    public boolean isExist(String key) {
        ...
        List<Object> result = redisTemplate.executePipelined(new RedisCallback<Object>() {
            ...
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                byte[] key = RBloomFilter.this.name.getBytes(Charsets.UTF_8);
