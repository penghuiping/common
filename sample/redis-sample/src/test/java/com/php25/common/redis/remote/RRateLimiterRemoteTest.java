...
public class RRateLimiterRemoteTest {
    ...
    public void test() throws Exception {
        RRateLimiter rRateLimiter = redisManager.rateLimiter(4, "test_rl");
        ...
        Assertions.assertThat(count).isGreaterThan(18).isLessThan(25);

        RRateLimiter rRateLimiter1 = redisManager.rateLimiter(4, "test_rl");
