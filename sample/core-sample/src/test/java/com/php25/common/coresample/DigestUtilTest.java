...
public class DigestUtilTest {
    ...
    public void hash() {
        ...
        String tmp = Hashing.md5().hashString("123123123", Charset.forName("utf-8")).toString().toUpperCase();
        ...
        String tmp1 = Hashing.sha256().hashString("123123123", Charset.forName("utf-8")).toString();
