...
import com.php25.common.jdbcsample.sqlite.dto.CustomerDto;
...
public class DbTest {
    ...
    public void before() throws Exception {
        ...
        company.setNew(true);
        company.setEnable(1);
        SqlParams sqlParams = Queries.sqlite().from(Company.class).insert(company);
        ...
        for (int i = 0; i < 3; i++) {
            ...
            SqlParams sqlParams1 = Queries.sqlite().from(Customer.class).insert(customer);
            QueriesExecute.sqlite().singleJdbc().with(jdbcTemplate).insert(sqlParams1);
