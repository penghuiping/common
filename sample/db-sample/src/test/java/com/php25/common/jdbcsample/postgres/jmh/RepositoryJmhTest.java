...
public class RepositoryJmhTest {
    ...
    public void init() {
        ...
        jdbcTemplate.update("create table t_customer (id bigint,username varchar(20),password varchar(50),age int,create_time timestamp ,update_time timestamp,`enable` bit)");
