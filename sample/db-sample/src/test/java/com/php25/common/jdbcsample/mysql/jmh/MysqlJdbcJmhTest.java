...
//        hikariDataSource.setPassword("root");
    ...
    public void insert0() throws Exception {
        this.db.getJdbcPair().getJdbcTemplate().update("insert into t_customer(`username`,`password`,`age`,`create_time`,`update_time`,`version`,`enable`,`score`,`company_id`) values (?,?,?,now(),null,?,?,?,?)", "jack", "123456", 12, 1, 1, 0, 0);
    }
