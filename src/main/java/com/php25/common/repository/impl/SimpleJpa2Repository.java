package com.php25.common.repository.impl;
 ...
 * @author Mark Paluch
 */
public class SimpleJpa2Repository<T, ID extends Serializable>
    ...
    /**
     * Creates a new {@link org.springframework.data.jpa.repository.support.SimpleJpaRepository} to manage objects of the given {@link JpaEntityInformation}.
     *
     * @param entityInformation must not be {@literal null}.
     * @param entityManager     must not be {@literal null}.
     */
    public SimpleJpa2Repository(JpaEntityInformation<T, ?> entityInformation, EntityManager entityManager) {
     ...
     */
    public SimpleJpa2Repository(Class<T> domainClass, EntityManager em) {
    ...
    public List<T> findAll(Iterable<ID> ids) {
        ...
        com.php25.common.repository.impl.SimpleJpa2Repository.ByIdsSpecification<T> specification = new com.php25.common.repository.impl.SimpleJpa2Repository.ByIdsSpecification<T>(entityInformation);
    ...
    public <S extends T> S findOne(Example<S> example) {
        try {
            return getQuery(new com.php25.common.repository.impl.SimpleJpa2Repository.ExampleSpecification<S>(example), example.getProbeType(), (Sort) null).getSingleResult();
        } catch (NoResultException e) {
            return null;
        }
    }
    ...
    public <S extends T> long count(Example<S> example) {
        return executeCountQuery(getCountQuery(new com.php25.common.repository.impl.SimpleJpa2Repository.ExampleSpecification<S>(example), example.getProbeType()));
    }
    ...
    public <S extends T> boolean exists(Example<S> example) {
        return !getQuery(new com.php25.common.repository.impl.SimpleJpa2Repository.ExampleSpecification<S>(example), example.getProbeType(), (Sort) null).getResultList()
                .isEmpty();
    }
    ...
    public <S extends T> List<S> findAll(Example<S> example, Sort sort) {
        return getQuery(new com.php25.common.repository.impl.SimpleJpa2Repository.ExampleSpecification<S>(example), example.getProbeType(), sort).getResultList();
    }
    ...
    public <S extends T> Page<S> findAll(Example<S> example, Pageable pageable) {
        ...
        com.php25.common.repository.impl.SimpleJpa2Repository.ExampleSpecification<S> spec = new com.php25.common.repository.impl.SimpleJpa2Repository.ExampleSpecification<S>(example);
        Class<S> probeType = example.getProbeType();
        TypedQuery<S> query = getQuery(new com.php25.common.repository.impl.SimpleJpa2Repository.ExampleSpecification<S>(example), probeType, pageable);
    ...
    public List<T> findAllEnabled() {
        List<T> result = em.createQuery("from " + getDomainClass().getName() + " where enable=1").getResultList();
        return result;
    }
     ...
     * {@link org.springframework.data.jpa.repository.support.SimpleJpaRepository#findAll(Iterable)}. Workaround for OpenJPA not binding collections to in-clauses
    ...
    private static class ExampleSpecification<T> implements Specification<T> {
        ...
        /**
         * Creates new {@link org.springframework.data.jpa.repository.support.SimpleJpaRepository.ExampleSpecification}.
         *
         * @param example
         */
