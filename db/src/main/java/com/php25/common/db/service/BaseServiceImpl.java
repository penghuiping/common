package com.php25.common.db.service;
 ...
 */
public class BaseServiceImpl<DTO, MODEL, ID extends Serializable> extends AbstractBaseAsyncServiceImpl<DTO, MODEL, ID> {
    ...
    public BaseServiceImpl(Class dtoClass, Class modelClass, BaseRepository baseRepository) {
