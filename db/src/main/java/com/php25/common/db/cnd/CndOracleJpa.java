 ...
 */
public class CndOracleJpa extends CndJpa {
    private static final Logger log = LoggerFactory.getLogger(CndOracleJpa.class);

    protected CndOracleJpa(Class cls, JdbcOperations jdbcOperations) {
